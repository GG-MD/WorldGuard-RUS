...
public class BukkitStringMatcher implements StringMatcher {
    ...
    public World matchWorld(Actor sender, String filter) throws CommandException {
        ...
        if (filter.charAt(0) == '#') {
            ...
            if (filter.equalsIgnoreCase("#main")) {
                ...
                throw new CommandException(WorldGuard.getInstance().getMessages().get("matcher.no-normal-world"));
                ...
                throw new CommandException(WorldGuard.getInstance().getMessages().get("matcher.no-nether-world"));
                ...
                throw new CommandException(WorldGuard.getInstance().getMessages().get("matcher.no-end-world"));
                ...
                if (parts.length == 1) {
                    throw new CommandException(WorldGuard.getInstance().getMessages().get("matcher.argument-expected-player"));
                }

                return matchPlayers(sender, parts[1]).iterator().next().getWorld();
            } else {
                throw new CommandException(WorldGuard.getInstance().getMessages().format("matcher.invalid-identifier", "filter", filter));
            }
        }
        ...
        throw new CommandException(WorldGuard.getInstance().getMessages().get("matcher.no-exact-world"));
    }
    ...
    public Iterable<? extends LocalPlayer> matchPlayers(Actor source, String filter) throws CommandException {
        if (Bukkit.getServer().getOnlinePlayers().isEmpty()) {
            throw new CommandException(WorldGuard.getInstance().getMessages().get("matcher.no-players"));
        }
        ...
        if (filter.charAt(0) == '#') {
            ...
            if (filter.equalsIgnoreCase("#world")) {
                ...
                throw new CommandException(WorldGuard.getInstance().getMessages().format("matcher.invalid-group", "filter", filter));
            }
        }
