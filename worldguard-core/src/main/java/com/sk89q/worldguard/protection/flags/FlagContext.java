...
public final class FlagContext {
    ...
    public LocalPlayer getPlayerSender() throws InvalidFlagFormat {
        if (sender.isPlayer() && sender instanceof LocalPlayer) {
            ...
            throw new InvalidFlagFormat(WorldGuard.getInstance().getMessages().get("flag-input.not-a-player"));
        }
    }
    ...
    public Integer getUserInputAsInt() throws InvalidFlagFormat {
        try {
            ...
            throw new InvalidFlagFormat(WorldGuard.getInstance().getMessages().format("flag-input.not-a-number", "input", input));
        }
    }
